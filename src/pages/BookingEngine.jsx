...
function BookingEngine() {
  ...
  return (
    <>
      ...
      linkPath={`/solutions/booking-engine/attraction-d-edge`}
      ...
      <Section2Area
      title={`SynXis`}
      linkPath={`/solutions/booking-engine/SynXis`}
      ...
      linkPath={`/solutions/booking-engine/nile-cruise-booking-engine`}
