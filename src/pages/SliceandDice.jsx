...
const UtopiaBeachHotels = ({ blogPosts }) => {
  const [otherPosts, setOtherPosts] = useState([]);
  const location = useLocation();
  const searchParams = new URLSearchParams(location.search);
  const id = searchParams.get("id");
  useEffect(() => {
    document.title = "Introducing the new Utopia Beach Hotels";
  ...
  return (
    <>
      <NewsName name="Introducing the new Utopia Beach Hotels" />
      {/*News */}
                ...
                <div class="col-md-12">
                  <div class="blog_details">
                    <div class="blog_dtl_thumb">
                      <img src="assets/images/news-slice.jpg" alt="" />
                    </div>

                    <div class="blog_dtl_content bg-news-details">
                      <div class="blog_dtl_top_bs pt-2">
                        <span>
                          <i class="fa fa-calendar"></i>2 FEB 2023{" "}
                        </span>
                      </div>
                      <h2 className="mb-4">
                      ...
                      <p>
                        We are proud to announce the Utopia Beach Hotels' new
                        website launch. It is now live and waiting for the
                        endless number of guests’ bookings. Take a look:
                        https://utopiabeachhotels.com/
                      </p>
...
export default UtopiaBeachHotels;
