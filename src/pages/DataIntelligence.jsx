...
function DataIntelligence() {
    ...
    return (
        ...
        linkPath={`/d-edge/data-intelligence/price-monitoring`}
        ...
        linkPath={`/d-edge/data-intelligence/price-recommendation`}
        ...
        linkPath={`/d-edge/data-intelligence/performance-analysis`}
