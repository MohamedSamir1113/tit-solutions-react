...
const CrystalInnHotel = ({ blogPosts }) => {
  ...
  return (
    <>
      <NewsName name="Crystal Inn Hotel El Alamein Website Launched by T.I.T Solutions" />
      {/*News */}
                ...
                <div class="col-md-12">
                  <div class="blog_details">
                    <div class="blog_dtl_thumb">
                      <img src="assets/images/news-crystal.jpg" alt="" />
                    </div>

                    <div class="blog_dtl_content">
                      <div class="blog_dtl_top_bs pt-2">
                        <span>
                          <i class="fa fa-calendar"></i>1 DEC 2022{" "}
                        </span>
                      </div>
                      <h2 className="mb-4">
                      Crystal Inn Hotel El Alamein Website Launched by T.I.T Solutions
                      ...
                      <p>
                      With honor and pleasure, we are sharing with you our new Website project launch for Crystal Inn Hotel El Alamein
                      </p>
...
export default CrystalInnHotel;
